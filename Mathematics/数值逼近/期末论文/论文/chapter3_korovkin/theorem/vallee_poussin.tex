\subsection{Weierstrass 第二逼近定理与 Vallée-Poussin 算子}

前面我们用 Bernstein 多项式证明了 Weierstrass 第一逼近定理，本节引入 Vallée-Poussin 算子，给出 Weierstrass 第二逼近定理的构造性证明。

\subsubsection{Vallée-Poussin 算子的定义与三角多项式表示}

定义 Vallée-Poussin 算子（简称 V-P 算子）
\[
